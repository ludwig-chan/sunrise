  ...
  <div class="character-status">
    ...
    <div class="status-grid">
      <div class="status-item">
        ...
        <span :class="{ 'stat-low': character.health < 30 }">{{ character.health }}%</span>
      </div>
      <div class="status-item">
        ...
        <span :class="{ 'stat-low': character.energy < 30 }">{{ character.energy }}%</span>
      </div>
      <div class="status-item">
        <label><StatusIcon type="satiety" style="color: rgb(255, 153, 0)" /></label>
        <span class="status-label">饱食度</span>
        <ProgressBar :value="character.satiety" color="rgb(255, 153, 0)" statusMode />
        <span :class="{ 'stat-low': character.satiety < 30 }">{{ character.satiety }}%</span>
      </div>
      <div class="status-item">
        ...
        <span :class="{ 'stat-low': character.mood < 30 }">{{ character.mood }}%</span>
      </div>
      <div class="status-item">
        ...
        <span :class="{ 'stat-low': character.hygiene < 30 }">{{ character.hygiene }}%</span>
      </div>
      <div class="status-item">
        ...
        <span :class="{ 'stat-low': character.mana < 30 }">{{ character.mana }}%</span>
      </div>
      <!-- 体温条 -->
