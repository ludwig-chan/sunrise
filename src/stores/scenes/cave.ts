  ...
  actions: {
    ...
    async deepMine() {
      ...
      try {
        ...
        floatingText('+' + actualAmount + ' 铁矿石', 'gain');
    ...
    async gatherCoal() {
      ...
      try {
        ...
        floatingText('+' + actualAmount + ' 煤炭', 'gain');
    ...
    async searchTreasure() {
      ...
      if (roll < 0.3) {
        ...
        try {
          ...
          floatingText('+' + actualAmount + ' 水晶', 'gain');
        ...
        try {
          ...
          floatingText('+' + actualAmount + ' 骨头', 'gain');
    ...
    async enhancedMine() {
      ...
      if (Math.random() < 0.4) {
        try {
          ...
          floatingText('+' + crystalAmount + ' 水晶', 'gain');
          gained.push('1 块水晶');
        } catch {
          // 水晶库存不足，跳过
        }
